...
public final class Prefs {
  ...
  public static String keywordFilterRules(Context c){ return p(c).getString("keyword_filter_rules", ""); }
  ...
  public static void save(Context c,String baseUrl,String secret,String deviceId,boolean enabled,boolean filterEnabled,String block,String remove,String removeSentences,String removeLines,String senderRules,String keywordForwardRules,String keywordFilterRules){
  ...
  public static void setAlwaysActiveEnabled(Context c,boolean enabled){ p(c).edit().putBoolean("always_active_enabled",enabled).apply(); }
}
